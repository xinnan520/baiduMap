...
(function () {
    ...
    var a = "png";
    var e = BMapGLLib.TextIconOverlay = function (f, h, g, c) {
        this._position = f;
        this._text = h;
        this._options = g || {};
        this._styles = this._options.styles || [];
        this._options._cluster = c || [];
    ...
    e.prototype._setupDefaultStyles = function () {
        ...
        for (var g = 0, f; f = h[g]; g++) {
            this._styles.push({url: b + g + "." + a, size: new BMapGL.Size(f, f)})
        }
    };
    e.prototype.initialize = function (f) {
        ...
        const markers = this._options.cluster._markers;
        const handleClick = this._options.cluster._markerClusterer._onClusterClick
        this._domElement.onclick = (e) => {
            e.preventDefault()
            handleClick(markers)
        };
    ...
    e.prototype._buildCssText = function (g) {
        ...
        if (n instanceof BMapGL.Size) {
            if (k instanceof BMapGL.Size) {
                ...
                m.push("height:" + n.height + "px; line-height:" + (g.lineHeight || n.height) + "px;");
