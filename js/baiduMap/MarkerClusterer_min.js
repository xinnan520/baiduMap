...
(function () {
    ...
    var d = function (i) {
        ...
        return new BMapGL.Bounds(new BMapGL.Point(h, l), new BMapGL.Point(k, j))
    };
    ...
    var e = BMapGLLib.MarkerClusterer = function (l, h) {
        if (!l) {
            return
        }
        this._map = l;
        ...
        this._onClusterClick = k.onClusterClick || function(){};
    ...
    e.prototype.onClusterClick = function (markers) {
        return markers
    };
    ...
    function g(h) {
        ...
        this._isReal = false;
        this._clusterMarker = new BMapGLLib.TextIconOverlay(this._center, this._markers.length, {styles: this._markerClusterer.getStyles(),cluster: this})
    }
    ...
    g.prototype.addMarker = function (k) {
        ...
        if (!this._center) {
            ...
            if (this._isAverageCenter) {
                ...
                this._center = new BMapGL.Point(m, o);
                this.updateGridBounds()
            }
        }
        k.isInCluster = true;
    ...
    g.prototype.updateGridBounds = function () {
        var h = new BMapGL.Bounds(this._center, this._center);
    ...
    g.prototype.getBounds = function () {
        var k = new BMapGL.Bounds(this._center, this._center);
        for (var j = 0, h; h = this._markers[j]; j++) {
